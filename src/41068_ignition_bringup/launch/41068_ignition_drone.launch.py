...
<<<<<<< HEAD:41068_ignition_bringup/launch/41068_ignition_drone.launch.py
        arguments=['-topic', '/robot_description', '-x', '9.5', '-y', '-12', '-z', '2.0'] # z is height above ground
=======
        arguments=['-topic', '/robot_description', '-z', '2.0'] # z is height above ground
>>>>>>> d78a8dc20ab974671cc9f62a8d566ecf5d5cde4d:src/41068_ignition_bringup/launch/41068_ignition_drone.launch.py
    )
